  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-white disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        secondary: 'bg-surface border border-border text-foreground hover:bg-surface-elevated hover:border-neutral-500',
        outline: 'border border-border bg-transparent text-foreground hover:bg-surface hover:text-white',
        ghost: 'hover:bg-surface hover:text-foreground text-foreground-secondary',
        destructive: 'bg-state-error text-white hover:bg-red-600',
